...
class Book(db.Model):
    __tablename__ = "books"
    __searchable__ = ['title', 'author','school', 'translateversion', 'price']
    ...
    def __init__ (self, title, author, serie, school, edition, translateversion, phisicalstate, price, user_cpf):
        self.title = title
        self.author = author
        self.serie = serie
        self.school = school
